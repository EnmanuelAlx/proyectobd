...
class User extends Authenticatable
{
    ...
    public static function crearEgresado(array $input){
        ...
        DB::insert("INSERT INTO usuarios (id, nombre, direccion, password, tipo, id_escuela, id_extension, remember_token) VALUES ('$id', '$nombre', '$direccion', '$password', $tipo, $escuela, $extension, '')");
